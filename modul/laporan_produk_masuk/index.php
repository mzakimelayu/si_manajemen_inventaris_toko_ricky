<?php
    $judul_halaman = "Laporan Produk Masuk";
...
<?php include '../../layout/sidebar.php'; ?>
    ...
    <main class="flex-1 p-2 sm:p-4 lg:p-6 animate-fade-in">
        <div class="bg-gray-100 rounded-lg shadow p-4 sm:p-6">
            <h2 class="text-2xl font-bold mb-6 text-pink-600">Laporan Produk Masuk</h2>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-pink-200">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Harga Beli</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td class='px-4 py-3 text-sm text-gray-700'>Rp ".number_format($row['harga_beli'], 0, ',', '.')."</td>";
