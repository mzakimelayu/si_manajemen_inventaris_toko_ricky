          ...
          <main class="flex-1 p-2 sm:p-4 lg:p-6 bg-gradient-to-br from-pink-50 to-indigo-50 animate-slide-in-up">
              <div class="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 animate-scale-in">
                  ...
                  <div class="p-3 sm:p-4 lg:p-6 animate-slide-in-up">
                      <!-- Pesan Data Sukses -->
                      <?php if(isset($_SESSION['produk_sukses'])) { ?>
                          <div id="alert-message" class="mb-4 bg-gradient-to-br from-green-50 via-emerald-100 to-teal-50 p-4 rounded-xl shadow-lg transform hover:-translate-y-0.5 transition-all duration-300 flex justify-between items-center animate-pulse" role="alert">
                              <div class="flex items-center space-x-3">
                                  ...
                                  <div>
                                      ...
                                      <p class="text-green-600 text-sm"><?php echo $_SESSION['produk_sukses']; ?></p>
                                  </div>
                              </div>
                      ...
                      <?php unset($_SESSION['produk_sukses']); } ?>

                      <div class="flex flex-col sm:flex-row gap-4 mb-6">
                          <div class="flex-1">
                              <div class="relative animate-slide-in-left">
                                  <input type="text" id="searchInput" class="w-full pl-10 pr-4 py-2 bg-pink-200 border border-pink-300 rounded-lg focus:ring-2 focus:ring-pink-400 focus:border-pink-400 focus:outline-none text-sm sm:text-base" placeholder="Cari produk...">
                      ...
                      <div class="overflow-x-auto rounded-lg border border-gray-200 animate-scale-in">
                          <table id="produkTable" class="min-w-full">
                              <thead>
                                  <tr class="bg-pink-200">
                                      <th class="px-2 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-semibold text-indigo-500 cursor-pointer" data-column="id">
                                      ...
                                      <th class="px-2 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-semibold text-indigo-500 cursor-pointer" data-column="kode_produk">
                                          <div class="flex items-center justify-center gap-1">
                                      ...
                                      <th class="px-2 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-semibold text-indigo-500 cursor-pointer" data-column="nama_produk">
                                          <div class="flex items-center justify-center gap-1">
                                      ...
                                      <th class="px-2 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-semibold text-indigo-500 cursor-pointer" data-column="nama_kategori">
                                          <div class="flex items-center justify-center gap-1">
                                              <span>Kategori</span>
                                              <svg class="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"/>
                                      ...
                                      <th class="px-2 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-semibold text-indigo-500 cursor-pointer" data-column="nama_satuan">
                                          <div class="flex items-center justify-center gap-1">
                                              <span>Satuan</span>
                                              <svg class="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"/>
                                      ...
                                      <th class="px-2 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-semibold text-indigo-500 cursor-pointer" data-column="stok">
                                          <div class="flex items-center justify-center gap-1">
                                              <span>Stok</span>
                                              <svg class="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"/>
                                      ...
                                      <th class="px-2 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-semibold text-indigo-500 cursor-pointer" data-column="stok_minimum">
                                          <div class="flex items-center justify-center gap-1">
                                              <span>Stok Min</span>
                                              <svg class="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"/>
                                      ...
                                      <th class="px-2 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-semibold text-indigo-500 cursor-pointer" data-column="harga_beli">
                                          <div class="flex items-center justify-center gap-1">
                                      ...
                                      <th class="px-2 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-semibold text-indigo-500 cursor-pointer" data-column="harga_jual">
                                          <div class="flex items-center justify-center gap-1">
                                      ...
                                      <th class="px-2 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-semibold text-indigo-500">Aksi</th>
                                  </tr>
                              </thead>
          ...
          function renderTable(data = tableData) {
              ...
              paginatedData.forEach((row, index) => {
                  ...
                  tr.innerHTML = `
                      ...
                      <td class="px-4 py-3 border-b border-r border-rose-300">${row.kode_produk}</td>
                      <td class="px-4 py-3 border-b border-r border-rose-300">${row.nama_produk}</td>
                      <td class="px-4 py-3 border-b border-r border-rose-300">${row.nama_kategori}</td>
                      <td class="px-4 py-3 border-b border-r border-rose-300">${row.nama_satuan}</td>
                      <td class="px-4 py-3 border-b border-r border-rose-300">${row.stok}</td>
                      <td class="px-4 py-3 border-b border-r border-rose-300">${row.stok_minimum}</td>
                      <td class="px-4 py-3 border-b border-r border-rose-300">${row.harga_beli}</td>
                      <td class="px-4 py-3 border-b border-r border-rose-300">${row.harga_jual}</td>
                      <td class="px-4 py-3 border-b border-rose-300">
                          <div class="flex justify-center space-x-3">
                              <button onclick="detailProduk(${row.id})" class="text-fuchsia-300 hover:text-fuchsia-300 p-1.5 rounded-full hover:bg-pink-200 group" title="Lihat Detail Produk">
                              ...
                              <button onclick="editProduk(${row.id})" class="text-pink-400 hover:text-pink-600 p-1.5 rounded-full hover:bg-pink-200 group" title="Edit Data Produk">
                                  <div class="absolute z-10 hidden group-hover:block bg-gray-900 text-white text-xs rounded-lg py-1 px-3 -mt-14 -ml-16">
                                      Edit Data Produk
                                  </div>
                                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              ...
                              <button onclick="hapusProduk(${row.id})" class="text-rose-500 hover:text-rose-500 p-1.5 rounded-full hover:bg-pink-200 group" title="Hapus Data Produk">
                                  <div class="absolute z-10 hidden group-hover:block bg-gray-900 text-white text-xs rounded-lg py-1 px-3 -mt-14 -ml-16">
                                      Hapus Data Produk
                                  </div>
                                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
