                ...
                <?php
                    ...
                    <div id="alert-message" class="mb-4 bg-gradient-to-br from-green-50 via-emerald-100 to-teal-50 p-4 rounded-xl shadow-lg transform hover:-translate-y-0.5 transition-all duration-300 flex justify-between items-center animate-pulse" role="alert">
                        ...
                        <div>
                            ...
                            <p class="text-green-600 text-sm"><?php echo $_SESSION['pengguna_sukses']; ?></p>
                        </div>
                        </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 mb-6">
                    <div class="flex-1">
                        <div class="relative animate-slide-in-left">
                            <input type="text" id="searchInput" class="w-full pl-10 pr-4 py-2 bg-pink-200 border border-pink-300 rounded-lg focus:ring-2 focus:ring-pink-400 focus:border-pink-400 focus:outline-none text-sm sm:text-base" placeholder="Cari pengguna...">
                    ...
                    <table id="penggunaTable" class="min-w-full">
                        <thead>
                            <tr class="bg-pink-200">
                                <th class="px-2 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-semibold text-indigo-500 cursor-pointer" data-column="id_pengguna">
                                ...
                                <th class="px-2 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-semibold text-indigo-500 cursor-pointer" data-column="nama_pengguna">
                                    <div class="flex items-center justify-center gap-1">
                                ...
                                <th class="px-2 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-semibold text-indigo-500 cursor-pointer" data-column="username">
                                    <div class="flex items-center justify-center gap-1">
                                        <span>Username</span>
                                        <svg class="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"/>
                                ...
                                <th class="px-2 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-semibold text-indigo-500 cursor-pointer" data-column="role">
                                    <div class="flex items-center justify-center gap-1">
                                        <span>Peran</span>
                                        <svg class="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"/>
                                ...
                                <th class="px-2 sm:px-4 py-2 sm:py-3 text-center text-xs sm:text-sm font-semibold text-indigo-500 cursor-pointer" data-column="nohp">
                                    <div class="flex items-center justify-center gap-1">
                                        <span>No. HP</span>
                                        <svg class="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"/>
        ...
        function renderTable(data = tableData) {
            ...
            paginatedData.forEach((row, index) => {
                ...
                tr.innerHTML = `
                    ...
                    <td class="px-4 py-3 border-b border-r border-rose-300">${row.nama_pengguna}</td>
                    <td class="px-4 py-3 border-b border-r border-rose-300">${row.username}</td>
                    <td class="px-4 py-3 border-b border-r border-rose-300">${row.role}</td>
                    <td class="px-4 py-3 border-b border-r border-rose-300">${row.nohp}</td>
                    <td class="px-4 py-3 border-b border-rose-300">
                        <div class="flex justify-center space-x-3">
                            <button onclick="lihatPengguna(${row.id_pengguna})" class="text-fuchsia-300 hover:text-fuchsia-300 p-1.5 rounded-full hover:bg-pink-200 group" title="Lihat Detail Pengguna">
                            ...
                            <button onclick="editPengguna(${row.id_pengguna})" class="text-pink-400 hover:text-pink-600 p-1.5 rounded-full hover:bg-pink-200 group" title="Edit Data Pengguna">
                                <div class="absolute z-10 hidden group-hover:block bg-gray-900 text-white text-xs rounded-lg py-1 px-3 -mt-14 -ml-16">
                                    Edit Data Pengguna
                                </div>
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            ${row.username != 'admin' ? `
                            <button onclick="hapusPengguna(${row.id_pengguna})" class="text-rose-500 hover:text-rose-500 p-1.5 rounded-full hover:bg-pink-200 group" title="Hapus Data Pengguna">
                                <div class="absolute z-10 hidden group-hover:block bg-gray-900 text-white text-xs rounded-lg py-1 px-3 -mt-14 -ml-16">
                                    Hapus Data Pengguna
                                </div>
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
