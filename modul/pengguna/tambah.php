...
<?php include '../../layout/sidebar.php'; ?>
    ...
    <main class="flex-1 p-2 sm:p-4 lg:p-6 animate-slide-in-down">
        <div class="bg-gray-100 rounded-lg shadow-md p-6 animate-slide-in-up">
            <h2 class="text-2xl font-semibold mb-6 text-pink-600 animate-bounce-in">Tambah Pengguna</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <input type="text" name="username" class="w-full px-3 py-2 border border-pink-200 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-400" placeholder="Masukkan username" required>
                </div>
                ...
                <input type="text" name="nama_lengkap" class="w-full px-3 py-2 border border-pink-200 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-400" placeholder="Masukkan nama lengkap" required>
                </div>
                ...
                <input type="text" name="nomor_hp" class="w-full px-3 py-2 border border-pink-200 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-400" placeholder="Masukkan nomor HP" required>
                </div>
            ...
            <div class="form-group animate-slide-in-up">
                ...
                <textarea name="alamat" rows="3" class="w-full px-3 py-2 border border-pink-200 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-400" placeholder="Masukkan alamat lengkap" required></textarea>
            </div>
