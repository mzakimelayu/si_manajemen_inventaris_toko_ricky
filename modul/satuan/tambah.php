<?php
    $judul_halaman = "Tambah Satuan Produk";
...
<?php include '../../layout/sidebar.php'; ?>
    ...
    <main class="flex-1 p-2 sm:p-4 lg:p-6 animate-slide-in-down">
        <div class="bg-gray-100 rounded-lg shadow-md p-6 animate-slide-in-up">
            <h2 class="text-2xl font-semibold mb-6 text-pink-600 animate-bounce-in">Tambah Satuan</h2>
            ...
            <form action="proses_tambah.php" method="POST" class="space-y-4 animate-scale-in">
                <div class="form-group animate-slide-in-left">
                    ...
                    <input type="text" name="nama_satuan" class="w-full px-3 py-2 border border-pink-200 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-400" placeholder="Masukkan nama satuan" required>
                </div>
