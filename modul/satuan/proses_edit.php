  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $check_nama = mysqli_query($koneksi, "SELECT * FROM satuan_produk WHERE nama_satuan = '$nama_satuan' AND id_satuan_produk != '$id' AND status_dihapus = 0");
      ...
      $query = "UPDATE satuan_produk SET 
                nama_satuan = '$nama_satuan'
                WHERE id_satuan_produk = '$id'";
