<?php
    $judul_halaman = "Detail Data Produk Masuk";
    ...
    <main class="flex-1 p-2 sm:p-4 lg:p-6 bg-gray-100">
        <?php
            ...
            $query = "SELECT p.*, u.nama_lengkap as nama_lengkap_pengguna 
                     ...
                     WHERE p.id_penerimaan_produk = $id_penerimaan";
          ...
          <div class="max-w-4xl mx-auto bg-pink-200 p-8 rounded-lg shadow-lg animate-slide-in-down" id="printArea">
              ...
              <div class="grid grid-cols-2 gap-8 mb-8">
                  <div class="bg-rose-300 p-6 rounded-lg shadow-md animate-slide-in-left">
                      <h2 class="text-xl font-bold mb-4 text-gray-800 border-b pb-2">Detail Produk Masuk</h2>
                      <p class="<?php echo $penerimaan['status_dihapus'] == 1 ? 'bg-rose-500 text-white' : 'bg-pink-400 text-white'; ?> inline-block px-3 py-1 rounded text-sm mt-3">Status: <?php echo $penerimaan['status_dihapus'] == 1 ? 'DIBATALKAN' : 'SELESAI'; ?></p>
                      <p class="text-indigo-900 mt-2">Tanggal: <?php echo date('d/m/Y', strtotime($penerimaan['tanggal'])); ?></p>
                  </div>
                  <div class="bg-rose-300 p-6 rounded-lg shadow-md animate-slide-in-right">
                      ...
                      <p class="text-indigo-900"><?php echo $penerimaan['keterangan']; ?></p>
                      <p class="text-indigo-900 mt-2">Diterima Oleh: <?php echo $penerimaan['nama_lengkap_pengguna']; ?></p> 
                  </div>
              </div>
              ...
              <table class="w-full mb-8 animate-scale-in">
                  <thead>
                      <tr class="bg-pink-400">
                          ...
                          <th class="py-2 px-4 text-right text-white">Harga Beli</th>
                  ...
                  <tbody>
                      <?php
                          ...
                          $query_detail = "SELECT dp.*, p.nama_produk, p.kode_produk 
                                       ...
                                       WHERE dp.penerimaan_produk_id = $id_penerimaan";
                      ...
                      <tr class="border-b border-pink-300 hover:bg-pink-100 animate-bounce-in">
                          ...
                          <td class="py-2 px-4 text-right"><?php echo number_format($row['harga_beli'], 2, ',', '.'); ?></td>
              ...
              <div class="flex justify-end space-x-4 mt-6">
                  ...
                  <?php if($penerimaan['status_dihapus'] != 1) { ?>
                  <a href="edit.php?id=<?php echo $id_penerimaan; ?>" class="px-6 py-2.5 bg-pink-600 text-white rounded-full hover:bg-pink-400 transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg">
